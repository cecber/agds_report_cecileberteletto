...
Let's first install/open the packages.
...
packages <- c("dplyr", "tidyr", "parsnip", "workflows", "tune", 
              ...
              "xgboost", "doParallel", "yardstick", "viridis", "vip")
...
To beginn, we need to ensure for reproducibility and then download the data:
